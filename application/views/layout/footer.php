    ...
    <!-- SlimScroll -->
    <script src="<?php echo base_url('assets/theme/AdminLTE-v.2.4/'); ?>bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
    <!-- FastClick -->
    <script src="<?php echo base_url('assets/theme/AdminLTE-v.2.4/'); ?>bower_components/fastclick/lib/fastclick.js"></script>
    <!-- AdminLTE App -->
