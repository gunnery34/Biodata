...
<head>
	...
	<!-- Bootstrap 3.3.7 -->
	<link rel="stylesheet"
		href="<?php echo base_url('assets/theme/AdminLTE-v.2.4/'); ?>bower_components/bootstrap/dist/css/bootstrap.min.css">
	<!-- Font Awesome -->
	<link rel="stylesheet"
		href="<?php echo base_url('assets/theme/AdminLTE-v.2.4/'); ?>bower_components/font-awesome/css/font-awesome.min.css">
	<!-- Ionicons -->
	<link rel="stylesheet"
		href="<?php echo base_url('assets/theme/AdminLTE-v.2.4/'); ?>bower_components/Ionicons/css/ionicons.min.css">
	<!-- Theme style -->
	<link rel="stylesheet" href="<?php echo base_url('assets/theme/AdminLTE-v.2.4/'); ?>dist/css/AdminLTE.min.css">
	<!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
	<link rel="stylesheet"
		href="<?php echo base_url('assets/theme/AdminLTE-v.2.4/'); ?>dist/css/skins/_all-skins.min.css">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									...
									<p>
										...
										<small>Member since
											<?php echo $this->session->userdata('UsrCreated'); ?></small>
									</p>
								</li>
								<!-- Menu Footer-->
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="<?php echo base_url('main/sign_out') ?>"
