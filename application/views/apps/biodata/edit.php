		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-6"> <!-- BioName -->
								<div class="form-group">
									<div class="col-md-12">
										<label for="BioName" class="label-control">Nama<span style="color: #f00;">*</span></label>
										<?php
											$data_input = [
												'type' 							=> 'text',
												'name' 							=> 'BioName',
						...
						<div class="row">
							<div class="col-md-6"> <!-- BioBirthPlace -->
								<div class="form-group">
									<div class="col-md-12">
							...
							<div class="col-md-6"> <!-- BioBirthDate -->
								<div class="form-group">
									<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-6"> <!-- BioAddressCurrent -->
								<div class="form-group">
									<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6"> <!-- BioReligion -->
								<div class="form-group">
									<div class="col-md-12">
							...
							<div class="col-md-6"> <!-- BioPhoneNum -->
								<div class="form-group">
									<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6"> <!-- BioEducation -->
								<div class="form-group">
									<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group"><!-- BioGender -->
									<div class="col-md-12">
								...
								<div class="form-group"><!-- BioLanguage -->
									<div class="col-md-12">
							...
							<div class="col-md-6"> <!-- BioExperince -->
								<div class="form-group">
									<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6"> <!-- BioNationaly -->
								<div class="form-group">
									<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6"> <!-- BioStatusMarital -->
								<div class="form-group">
									<div class="col-md-12">
